...
<head>
    ...
    <!-- TITLE -->
    <title>Electro Store - Admin control panel manage administrator </title>
    <!-- META DESCRIPTION -->
    ...
    <section class="main-section">
        <div class="wrapper">
            <div class="manage-tbl">
                ...
                <br><br>
                <?php
                    //print add admin session variables
                ...
                <table class="tbl-100 text-center">
                    ...
                    <?php 
                        ...
                        //initializing serial number for admin 
                        $sn = 1;
                        ...
                        if($count > 0){
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo SITEURL; ?>admin/update-admin.php?admin_id=<?php echo $admin_id; ?>" class="btn secondary">Update</a>
                                        <a href="<?php echo SITEURL;?>admin/delete-admin.php?admin_id=<?php echo $admin_id; ?>" class="btn danger">Delete</a>
                                    </td>
                                </tr>
                                <?php
                            }
                            ...
                            echo "<div class='error text-center'>Admin table is empty!</div>";
                        }
