...
<head>
    ...
    <!-- TITLE -->
    <title>Electro Store - Admin control panel updating pending orders </title>
    <!-- META DESCRIPTION -->
        ...
        <div class="wrapper">
            <div class="update-orders text-center">
                <form action="" method="POST">
                    <h2>Pick the date of orders pending you wish to update</h2>
            ...
            <div class="manage-tbl-o">
                ...
                <table class="tbl-100 text-center">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM `tbl_orders` WHERE `status`='Pending'";
                        ...
                        if($count > 0){
                            ...
                            ?>
                            <td colspan="12">
                                <?php echo "<div class='error text-center'>No order pending!</div>"; ?>
                            </td>
                            <?php
                        } 
                    ?>
